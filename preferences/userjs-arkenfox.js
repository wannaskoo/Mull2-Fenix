...
pref("geo.provider.use_gpsd", false); // [LINUX] [HIDDEN PREF]
...
pref("network.gio.supported-protocols", ""); // [HIDDEN PREF] [DEFAULT: "" FF118+]
 ...
 * [SETTING] Privacy & Security>DNS over HTTPS>Increased/Max>Choose provider ***/
   // pref("network.trr.uri", "https://example.dns");
   // pref("network.trr.custom_uri", "https://example.dns");
 ...
 * [1] https://blog.mozilla.org/data/2021/09/15/data-and-firefox-suggest/ ***/
   // pref("browser.urlbar.quicksuggest.enabled", false); // [FF92+] [DEFAULT: false]
   // pref("browser.urlbar.suggest.quicksuggest.nonsponsored", false); // [FF95+] [DEFAULT: false]
   // pref("browser.urlbar.suggest.quicksuggest.sponsored", false); // [FF92+] [DEFAULT: false]
...
/* 0807: disable urlbar clipboard suggestions [FF118+] ***/
   // pref("browser.urlbar.clipboard.featureGate", false); // [DEFAULT: true FF125+]
...
/* 1241: disable insecure passive content (such as images) on https pages ***/
   // pref("security.mixed_content.block_display_content", true); // Defense-in-depth (see 1244)
...
pref("browser.contentanalysis.default_allow", false); // [FF124+] [DEFAULT: false]
 ...
 * won't use the system DNS. If the IP doesn't match then DoH won't work ***/
   // pref("network.trr.bootstrapAddr", "10.0.0.1"); // [HIDDEN PREF]
...
/* 6050: prefsCleaner: previously active items removed from arkenfox 115-127 ***/
   // pref("accessibility.force_disabled", "");
   // pref("browser.urlbar.dnsResolveSingleWordsAfterSearch", "");
   // pref("network.protocol-handler.external.ms-windows-store", "");
   // pref("privacy.partition.always_partition_third_party_non_cookie_storage", "");
   // pref("privacy.partition.always_partition_third_party_non_cookie_storage.exempt_sessionstorage", "");
   // pref("privacy.partition.serviceWorkers", "");
...
/* 8001: prefsCleaner: reset items useless for anti-fingerprinting ***/
   ...
   // pref("browser.zoom.siteSpecific", "");
   // pref("device.sensors.enabled", "");
   // pref("dom.enable_performance", "");
   // pref("dom.enable_resource_timing", "");
   // pref("dom.gamepad.enabled", "");
   // pref("dom.maxHardwareConcurrency", "");
   // pref("dom.w3c_touch_events.enabled", "");
